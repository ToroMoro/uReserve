...
class EventController extends Controller
{
    ...
    public function index()
    {
        ...
        $reservedPeople = DB::table('reservations')->select('event_id', DB::raw('sum(number_of_people) as numberOfPeople'))
    ...
    public function store(StoreEventRequest $request)
    {
        ...
        if($check) {
            session()->flash('status', 'Date and time is duplicated');
            return view('manager.events.create');
        }
        ...
        session()->flash('status', 'Create finished');
     ...
     * @return \Illuminate\Http\Response
     */
    public function past(Event $event)
    {
        $today = Carbon::today();
